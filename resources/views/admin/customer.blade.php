    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalTitle"><i class="fa fa-info"></i> <span id="modalAction"></span> Khách hàng</h5>
            ...
            <div class="modal-body">
                <form method="post" id="frm" enctype="multipart/form-data">
                    ...
                    <div class="form-group form-row">
                        <label for="txtName" class="col-sm-3 col-form-label">Họ và tên: </label>
                        <div class="col-sm">
                            <input type="text" class="form-control" id="txtName" name="CUSNAME"
                    ...
                    <div class="form-group form-row">
                        ...
                        <div class="col-sm">
                            <input type="text" class="form-control" id="txtPhone" name="CUSPHONE"
                                   maxlength="50" placeholder="Nhập số điện thoại." autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group form-row">
                        <label for="txtAddress" class="col-sm-3 col-form-label">Địa chỉ: </label>
                        <div class="col-sm">
                            <input type="text" class="form-control" id="txtAddress" name="CUSADDRESS"
                                   maxlength="50" placeholder="Nhập địa chỉ." autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group form-row">
                        <label for="txtEmail" class="col-sm-3 col-form-label">Email: </label>
                        <div class="col-sm">
                            <input type="email" class="form-control" id="txtEmail" name="CUSEMAIL"
                    ...
                    <div class="form-group form-row">
                        ...
                        <div class="col-sm">
                            <input type="text" class="form-control" id="txtUserName" name="CUSUSERNAME"
                    ...
                    <div class="form-group form-row">
                        ...
                        <div class="col-sm">
                            <input type="password" class="form-control" id="txtPassword" name="CUSPASSWORD"
                                   maxlength="50" placeholder="Nhập mật khẩu." autocomplete="off">
                        </div>
                    </div>
                    <div class="form-group form-row">
                        <label for="txtType" class="col-sm-3 col-form-label">Loại khách hàng: </label>
                        <div class="col-sm">
                            <input type="number" class="form-control" id="txtType" name="CUSTYPE"
...
<script>
    $(document).ready(function(){
                    ...
                    if (yesClicked) {
                        AjaxPost(api_url + '/customers/delete/' + rowId, null, function (result) {
                            if (result.error == 0) {
                                ...
                                var content = 'Khách hàng' + ' "' + result.data.CUSNAME + '" đã xóa!';
        ...
        var validator = $('#frm').validate({
            rules: {
                CUSNAME: 'required',
                CUSUSERNAME: 'required',
                CUSPASSWORD: 'required',
            },
            messages: {
                CUSNAME: 'Hãy nhập tên khách hàng.',
                CUSUSERNAME: 'Hãy nhập tên tài khoản',
                CUSPASSWORD: 'Hãy nhập mật khẩu',
            }
        });
        ...
        $('#editModal').modal({ show: false }).on('show.bs.modal', function (e) {
            ...
            if (infoData != null) {
                ...
                $('#txtName').val(infoData.CUSNAME);
                $('#txtPhone').val(infoData.CUSPHONE);
                $('#txtAddress').val(infoData.CUSADDRESS);
                $('#txtEmail').val(infoData.CUSEMAIL);
                $('#txtUserName').val(infoData.CUSUSERNAME);
                $('#txtType').val(infoData.CUSTYPE);
            ...
            if ($('#frm').valid()) {
                ...
                if (id > 0) { // update
                    AjaxPost(api_url + '/customers/update', data, function(res) {
                        if (res.error == 0) {
                            PNotify.success({title: 'Thành công', text: 'Khách hàng đã được cập nhật thành công.'});
                    ...
                    AjaxPost(api_url + '/customers/add', data, function(res) {
                        if (res.error == 0) {
                            PNotify.success({title: 'Thành công', text: 'Khách hàng đã được thêm thành công.'});
                            $('#editModal').modal('hide');
                            loadTable();
                        } else {
                            PNotify.alert({title: 'Cảnh báo', text: res.message});
